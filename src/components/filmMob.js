		...
		fetch(request)
			...
			.then((data) => {
				...
				for (let i = 0; i < data.countries.length; i++) {
					...
					document.getElementsByClassName(
						"flags"
					)[0].innerHTML += `<img class="flag" src="https://raw.githubusercontent.com/lipis/flag-icon-css/master/flags/4x3/${country_code}.svg"/>&nbsp;`
				}
		...
		<div className="filmMob-wrapper">
			...
			<div
				...
				<div className="factsInfo">
					Нажмите сюда, что бы прочитать интересные факты<br></br>P.S. возможны спойлеры
				</div>
